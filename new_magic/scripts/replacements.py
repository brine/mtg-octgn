...
tokenTypes = {
    ...
    'angelwarrior44w2': ('4 / 4 White Angel Warrior', '1ef4ab2f-0f3b-4d1a-baa2-4be9c315f599'),  #KHM
    ...
    'bird11u2': ('1 / 1 Blue Bird', '337fe1b7-952d-4974-96df-d5a53c9e17f8'), #only block flyers
    'bird11b': ('1 / 1 Black Bird', '738840b2-b08b-46de-8b39-3f2df8ecbfa1'),
    ...
    'construct11c2': ('1 / 1 Colorless Construct', '8941be34-f9d7-41f0-9749-400de2399c54'), #CNS CN2
    'construct31r': ('3 / 1 Red Construct', '2a7a9b68-2a77-4e26-95f3-289ac354107c'),
    'construct22c': ('2 / 2 Colorless Construct', '2f5e598f-b782-45f8-9c20-3f81fc03b655'),
    ...
    'demonberserker23r': ('2 / 3 Red Demon Berserker', '1895046f-925c-4718-b082-13df8a470b26'),
    ...
    'dragonspirit55r': ('5 / 5 Red Dragon Spirit', '76ec4d30-6d06-4aed-aa73-0c7fce0dc3fe'),
    ...
    'dwarfberserker21r': ('2 / 1 Red Dwarf Berserker', 'd4e47ce9-0df5-45de-9096-a22c07488f73'),
    ...
    'eldrazi1010c': ('10 / 10 Colorless Eldrazi', 'c289905c-9d77-4716-92b7-5cb88e4ef728'), #BFZ C19
    ...
    'elemental21r': ('2 / 1 Red Elemental', '906d8532-2d5e-49d9-ac29-13b2d742c0b5'), #CFX DIS OGW C20
    ...
    'elemental**r2': ('* / * Red Elemental', '734016c0-cd4a-47bb-97ab-10149435b259'),
    ...
    'elemental44m': ('4 / 4 Multicolor Blue Red Elemental', '3acd4738-ef7e-4ab1-930c-7e6bd5f7a3d9'),
    ...
    'faeriedragon11u': ('1 / 1 Blue Faerie Dragon', 'c4f1d4a3-4456-42e8-b3eb-bea8d1b9b3af'),
    ...
    'forestdryad11g': ('1 / 1 Green Forest Dryad', '25845c50-fb84-4290-9ac8-553a73765cb1'),
    ...
    'fungusbeast44g': ('4 / 4 Green Fungus Beast', 'c7a6e6e2-a26e-46e0-8aaf-9a08c489a011'),
    ...
    'giantwizard44u': ('4 / 4 Blue Giant Wizard', '69a891c2-e7b5-4c38-962e-84ece7d6bce8'),
    ...
    'goblinshaman22r': ('2 / 2 Red Goblin Shaman', 'f9996ba8-0d4f-4d69-ae72-920437b94e30'),
    ...
    'golem**c': ('* / * Colorless Golem', '22b63d54-3ce3-470c-a4fc-2b7c7c98fffc'),
    ...
    'golem33c3': ('3 / 3 Colorless Golem', '8c4bfa13-2d5b-40c0-86d5-330e812efcf2'), #flying
    ...
    'guenhwyvar41g': ('4 / 1 Green Guenhwyvar', '02c32551-b9dd-495f-97eb-6ef7bc6af2d2'),
    ...
    'humanmonk11g': ('1 / 1 Green Human Monk', 'd62b810a-54c4-437b-95f8-9333f0da6454'),
    ...
    'icingdeath': ('Icingdeath, Frost Tongue', 'b975c69a-5670-44f6-81ba-01d1d7f8e091'),
    'icymanalith': ('Icy Manalith Artifact', '4b857b1b-2dec-4893-a9f8-c5a6ff9950ff'),
    ...
    'insect11b2': ('1 / 1 Black Insect', '2cbb2741-d231-47b9-bc23-efa0dbd43346'), #flying
    ...
    'insect33g': ('3 / 3 Green Insect', 'cfd7aa65-17a7-4c45-8abe-b380e528d789'),
    ...
    'knight22w4': ('2 / 2 White Knight', 'ca422c14-4918-46a3-a88e-52453f2626b3'), #protection from red
    ...
    'komascoil33u': ("3 / 3 Blue Koma's Coil", '2d0bea16-0e93-4f33-b623-5f94ea64d3a5'),
    ...
    'mechtitan1010m': ('10 / 10 Mechtitan', 'c05c0e7f-0b38-46c7-a520-56ad1f5ce03b'),
    ...
    'mishraswarform44c': ("4 / 4 Colorless Mishra's Warform", '5d6bec32-8817-41e4-b9b5-94c8983cb177'),
    'monarch': ('The Monarch', '2b8d6bc4-b81b-40a0-93fb-5081fcb1990d'),
    'monk11w': ('1 / 1 White Monk', '5b6e6944-f114-42bc-bbea-cfff3e4f5fab'),
    'monk11r': ('1 / 1 Red Monk', '039afd18-072e-4ffb-80d3-00f7ff300303'),
    ...
    'ninja11u': ('1 / 1 Blue Ninja', '14d46beb-05b4-46cb-bf6c-235735c3e98a'),
    ...
    'ornithopter01c': ('0 / 1 Colorless Ornithopter', 'bc78018e-2139-4ad1-ba42-f15b9afcc38b'),
    ...
    'phyrexian22b': ('2 / 2 Black Phyrexian', '5d9ae2f3-aba4-451e-9201-a7b8e28542aa'),
    'phyrexiangolem33c': ('3 / 3 Colorless Phyrexian Colem', '37a1b9bc-942a-4425-ab9f-2491b0409d87'),
    ...
    'powerstone': ('Colorless Powerstone', 'c93bd99e-4eae-45aa-8c4c-2a0263e7d312'),
    ...
    'ratrogue11b': ('1 / 1 Black Rat Rogue', '286eb765-2e10-483e-89a8-518b4bcd922a'),
    ...
    'scrap': ('colorless scrap', 'd6a8bff8-6aad-4d6e-a18c-18066784fb7b'),
    ...
    'shard': ('Colorless Shard', '83d52b26-07e6-477d-81c2-ac0ced062e97'),
    ...
    'soldier11c': ('1 / 1 Colorless Soldier', 'f5b5adad-5eed-4134-a5f6-c6f9bd080f67'),
    ...
    'spider21b': ('2 / 1 Black Spider', 'ab99aa6a-3a40-4e37-82ec-adf09b5d1c78'),
    ...
    'spirit22u': ('2 / 2 Blue Spirit', 'd9dedaf6-7910-4197-adac-8287c673b4bf'),
    'spirit11m': ('1 / 1 Multicolor White Black Spirit', '55353de2-1086-4174-8904-b57db68708fd'), #EVE GTC RNA
    'spirit32m': ('3 / 2 Multicolor Red White Spirit', '88483e99-039a-4c6c-bef3-83caad221201'), #EVE GTC RNA
    ...
    'spirit22r': ('2 / 2 Red Spirit', '2d0170ba-72ef-4172-9971-a38325015d2f'),
    'spirit45g': ('4 / 5 Green Spirit', '511b67a4-4a51-4031-8736-cd005535b3db'),
    'spirit**g': ('* / * Green Spirit', '62bd21c1-1db0-4432-ad33-3f0198bbe175'),
    ...
    'treefolk**g2': ('* / * Green Treefolk', 'a29daa23-1f5e-4a0e-86fd-5ba31305aae3'),
    ...
    'trollwarrior44g': ('4 / 4 Green Troll Warrior', '91a97ff0-de44-4812-946e-164d7c53bb37'),
    ...
    'wurm44g': ('4 / 4 Green Wurm', '3a712adb-5665-4b34-a465-5e70344dc412'),
    ...
    'zombie22b3': ('2 / 2 Black Zombie', 'e587fbd6-f0fa-4918-83d8-9eb8091bd0be'), #decayed
    'zombie33c': ('3 / 3 Colorless Zombie', '4258d9ca-2b98-4b79-866d-6330ed397910'),
    ...
    'astarteswarrior22w': ("2 / 2 White Astartes Warrior", '0a6bb9c8-1bb5-4eff-8289-fffd11ae6707'),
    'spacemarinedevastator33w': ("3 /3 white Space Marine Devastator", 'b5615cf5-217b-4f2d-9ade-07202ac4121e'),
    'ultramarinehonourguard22w': ("2 / 2 White Ultramarines Honour Guard", '6257356b-8dbb-41ff-9fd2-d42ac0ee134b'),
    'zephyrim33w': ("3 / 3 White Zephyrim", '26b27892-ca5f-4b84-8909-4f89f37c9d8a'),
    'sicarianinfiltrator12u': ("1 / 2 Blue Sicarian Infiltrator", '4509ea54-5d93-4b5f-b7e4-20fedecf3f12'),
    'tyranogargoyle11u': ("1 / 1 Blue Tyrano Gargoyle", '5d0d5aae-3947-4a1a-a583-6e1b621b6cf2'),
    'vanguardsuppressor32u': ("3 / 2 Blue Vanguard Suppressor", '13406ae4-bb93-4360-9744-f341bcd79f38'),
    'arcoflagellant31b': ("3 / 1 Black Arco-Flagellant", 'c9abe3e0-29f9-42d1-9ffc-6a0b3c672114'),
    'astarteswarrior22b': ("2 / 2 Black Astartes Warrior", '8f438766-708f-44cc-a3b6-bf43c73000ff'),
    'cherubael44b': ("4 / 4 Black Cherubael", '22a8e32a-5d09-46c7-870a-20936dd187d6'),
    'necronwarrior22b': ("2 / 2 Black Necron Warrior", '761c034e-0243-4765-94a5-fc2961a6b423'),
    'plaguebearerofnurgle13b': ("1 / 3 Black Plaguebearer of Nurgle", '79a6c347-5b88-45d3-b8e3-e7273f1b388c'),
    'spawn33r': ("3 / 3 Red Spawn", 'fea163ac-c8d3-405e-b72b-83f0670ff87b'),
    'tyranid11g': ("1 / 1 Green Tyranid", '607155dc-1cd1-4c35-a11f-12ec8ee06af2'),
    'tyranid55g': ("5 / 5 Green Tyranid", '606f0815-0581-4a02-94f4-12ee8eb36d7d'),
    'tyranidwarrior33g': ("3 / 3 Green Tyranid Warrior", 'e984d9b8-a9f9-428e-bf32-e76c87d398f0'),
    'bluehorror22m': ("2 / 2 Multicolor Blue Red Blue Horror", '49baccef-4cd6-4db9-982d-a69b3ecc9a29'),
    'insect11c': ("1 / 1 Colorless Insect", '7f934d91-8313-4345-85a8-dcf84b4c3cab'),
    'robot44c': ("4 / 4 Colorless Robot", '3ce51609-1262-45ed-ba8c-55cdd135f276'),
    'laserbeak22u': ("2 / 2 Blue Laserbeak", '810aabc0-d582-43f5-a28e-e4105d56866f'),
    'ravage33b': ("3 / 3 Black Ravage", 'ef2eef22-695d-4783-8b4f-fde274a92900'),
    ...
    'ajaniemblem3': ("Ajani's Emblem", '9adc8c66-c877-40f3-b85a-d04f92460ea3'), #DMU
    ...
    'ellywickemblem': ("Ellywick's Emblem", '136d34d8-0d8d-4e26-830c-e3935ca917f0'), 
    ...
    'jayaemblem2': ("Jaya's Emblem", '836572d1-0037-4a9e-b2e7-37c394baf168'),
    'kaitoemblem': ("Kaito's Emblem", '28d93b0a-0816-47f3-ba22-670163dc4e1d'),
    'kayaemblem': ("Kaya's Emblem", '34d8e9d8-2c98-45de-a2bf-8de37c2b3929'),
    ...
    'lolthemblem': ("Lolth's Emblem", 'ef5aa818-9b07-4d5e-aed7-8137776cda99'),
    'lukkaemblem': ("Lukka's Emblem", 'e84884b1-0a90-4ee3-af66-4879ae1580b9'),
    'mordenkainenemblem': ("Mordenkainen's Emblem", '441cfbc8-3796-40be-854f-f0dba852fc43'),
    ...
    'rowanemblem2': ("Rowan's Emblem", '086fd079-55c3-4283-9034-a9a85b3b6324'), #scholar of sparks
    'saheeliemblem': ("Saheeli's Emblem", '5e17f597-a343-4e1e-989f-36cf1a6fdcd1'),
    ...
    'teferiemblem3': ("Teferi's Emblem", '39eb353f-5d4d-4ecd-9a5a-90a12bdf1be4'),
    ...
    'tezzeretemblem3': ("Tezzeret's Emblem", '2986ebaf-5d29-4021-b434-3a81f2d7a91d'), #TNEO
    'tibaltemblem': ("Tibalt's Emblem", 'd5718fe2-ab0d-4486-b27f-ec0bfff20c57'),
    'tyvaremblem': ("Tyvar's Emblem", '8929b748-148f-4967-a040-e687d5a57284'),
    ...
    'wrennemblem2': ("Wrenn's Emblem", '04e23d4d-8871-422c-bccd-cb1b5bd18b0b'),
    'zarielemblem': ("Zariel's Emblem", '441cfbc8-3796-40be-854f-f0dba852fc43')
}